...
void tSDRG_XXZ(int L, int chi, int Pdis, double Jdis, string BC, double S, double Jz, double Dim, double h, int Jseed, int rank)
{
...
int main(int argc, char *argv[])
{
    ...
    {
        tSDRG_XXZ(L, chi, Pdis, Jdis, BC, S, Jz, Dim, h, Jseed, rank);
    }
